...
# NixOS: deklaratywna alternatywa dla Ansible

<div />

- **Atomowe aktualizacje** - Zmiana albo w pełni się zastosuje, albo cofa. Nigdy połowiczny stan.
- **Rollback jedną komendą** - `nixos-rebuild switch --rollback` - poprzednia generacja zawsze dostępna.
- **Brak dryfu konfiguracji** - Każdy serwer z tym samym plikiem = identyczny system. Ansible aplikuje zmiany na istniejący stan.
